...
module.exports = {
  ...
  // Remove thought tag. This method finds the thought based on ID. It then updates the reactions array associated with the thought in question by removing it's \reactionId from the reactions array.
